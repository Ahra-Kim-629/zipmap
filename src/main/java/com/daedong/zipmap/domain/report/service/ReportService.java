package com.daedong.zipmap.domain.report.service;

import com.daedong.zipmap.domain.report.dto.ReportDTO;
import com.daedong.zipmap.domain.report.enums.ReportStatus;
import com.daedong.zipmap.domain.report.mapper.ReportMapper;
...
// 2. 첨부 파일이 있다면 공용 파일 시스템(FileUtilService)을 이용해 저장합니다.
            if (file != null && !file.isEmpty()) {
                ...
                com.daedong.zipmap.global.file.entity.File fileEntity = new com.daedong.zipmap.global.file.entity.File();
    ...
    public void deleteReport(Long id) {
        ...
        List<com.daedong.zipmap.global.file.entity.File> files = fileUtilService.getFileList("REPORT", id);
        for (com.daedong.zipmap.global.file.entity.File f : files) {
