...
public class MailService {
    ...
    public void sendPasswordResetMail(String email, String resetLink) throws Exception {
        ...
        String content = "<div style=\"margin: 0; padding: 0; background-color: #f6fbfa; font-family: 'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif;\">"
                + "<table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #eeeeee; border-top: 4px solid #3f8a7e;\">"
                + "  <tr>"
                + "    <td style=\"padding: 40px 30px; text-align: center;\">"
                + "      <h1 style=\"color: #3f8a7e; margin: 0; font-size: 28px; font-weight: bold;\">대동여집도</h1>"
                ...
                + "      <a href=\"" + resetLink + "\" style=\"display: inline-block; padding: 15px 35px; background-color: #3f8a7e; color: #ffffff; text-decoration: none; border-radius: 50px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 10px rgba(63, 138, 126, 0.3);\">비밀번호 재설정하기</a>"
                + "    </td>"
                + "  </tr>"
                + "  <tr>"
                ...
                + "      © 2024 ZipMap Team. All Rights Reserved."
                + "    </td>"
                + "  </tr>"
                + "</table>"
                + "</div>";
